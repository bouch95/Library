...
//const entries = Object.entries(countUniqueStrings);

// Sort the array based on the value
//entries.sort((a, b) => b[1] - a[1]);

// If you need the sorted object, you can convert the entries back to an object
//const sortedScores = Object.fromEntries(entries);

// Convert the object into an array and sort by value
//const sortedEntries = Object.entries(items).sort((a, b) => a[1] - b[1]);
